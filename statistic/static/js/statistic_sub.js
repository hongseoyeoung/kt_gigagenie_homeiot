		...
		function getTransform3CSS(){
			...
			if(support3d){
				cssArray = [
					...
					getTransform3dCSS('0%',	-600, 	0,		-1,	0,	'hidden'),


					getTransform3dCSS('0%',		-200, 	0,		1,	1,	'visible'),
					getTransform3dCSS('33.3%', 	0, 		0,		2,	1,	'visible'),
					getTransform3dCSS('66.7%', 	-200, 	0,		1,	1,	'visible'),
